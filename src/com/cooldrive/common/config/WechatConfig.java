package com.cooldrive.common.config;
...
public class WechatConfig {
	...
	public static final String APP_ID = "wx1d5f79b2286b25a3"; //公众号开发账号
	public static final String APP_SECRET = "25f8955a69bde1ad358d69274739474a";  //公众号开发密钥
	public static final String WECHAT_TOKEN = "cooldrivehud";

	public static final String MCH_ID = "1486307882";// 商户号 1486307882
	public static final String API_KEY="Pxt4U0vIyL91gd5MlATEoJaizGLgBlAQ";// API密钥，微信商户中设置

	// 异步通知URL
	public static final String NOTIFY_URL = "http://wx.cooldrivenavi.com/WxPay/payResult.action";
